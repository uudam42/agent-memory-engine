...
from memory_engine.services.verification_evidence import assign_creation_evidence_level
...
class ReflectionSkill:
    ...
    def analyze(self, inp: ReflectionInput) -> ReflectionAnalysis:
        ...
        # Issue 4: derive the verification-evidence level once for every
        # candidate generated by this task. Legacy callers (verification_status
        # only, no structured evidence) always land on agent_claimed at best —
        # see verification_evidence.assign_creation_evidence_level.
        evidence_level = assign_creation_evidence_level(
            verification_status=inp.verification_status,
            asserted_level=inp.asserted_evidence_level,
            evidence=inp.verification_evidence,
        )
        proposed_verification_evidence = inp.verification_evidence
        ...
        for constraint_text in inp.discovered_constraints:
            candidates.append(CandidateCreate(
                ...
                proposed_evidence_level=evidence_level.value,
